...
const FloatingWhatsApp: React.FC = () => {
  ...
  const handleSendMessage = () => {
    const finalMessage = message.trim() || "Hi! I'm interested in your travel packages. Please help me plan my trip.";
    // Use the phone number from APP_CONFIG or fallback to hardcoded number
    const whatsappNumber = APP_CONFIG.phone || '+917006377796';
    
    // Create WhatsApp URL manually since generateWhatsAppURL expects different parameters
