...
// // Updated handleSubmit function in CreatePackageModal.tsx
// // Remove all Authorization header logic and let cookies handle auth
...
//     // Make request WITHOUT Authorization header - let cookies handle auth
//     const response = await fetch('/api/admin/packages', {
//       method: 'POST',
//       headers: {
//         'Content-Type': 'application/json'
//         // No Authorization header - cookies will be sent automatically
//       },
...
//         // Clear localStorage token (it's not being used anyway)
