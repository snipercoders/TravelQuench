...
//               <div className="flex items-center justify-between">
//                 <div>
//                   <p className="text-green-100 text-sm font-medium">Total Packages</p>
...
//               <div className="flex items-center justify-between">
//                 <div>
//                   <p className="text-gray-300 text-sm font-medium">Pending Bookings</p>
...
//               <div className="flex items-center justify-between">
//                 <div>
//                   <p className="text-gray-300 text-sm font-medium">Completed Trips</p>
...
//                 <Calendar className="h-6 w-6 mr-2 text-orange-400" />
//                 Recent Bookings
//               </h2>
//             </div>
...
//                         </td>
//                         <td className="px-6 py-4 whitespace-nowrap">
//                           <div className="text-sm font-medium text-white">₹{booking.amount.toLocaleString()}</div>
//                         </td>
//                         <td className="px-6 py-4 whitespace-nowrap">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-6 flex items-center justify-between">
            ...
            <button
              ...
              disabled={refreshing}
              className="flex items-center px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-all duration-200 shadow-md transform hover:scale-105 disabled:opacity-50"
            >
          ...
          {stats.error && (
            <div className="mb-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg flex items-start">
              ...
              <div className="flex-1">
                <p className="text-sm text-yellow-600 font-medium">Data Warning</p>
                <p className="text-sm text-yellow-600">Some data may be incomplete. Showing available information.</p>
              </div>
            </div>
          )}
                ...
                <div>
                  ...
                  {process.env.NODE_ENV === 'development' && stats.debug && (
                    <p className="text-xs text-purple-200 mt-1">
                      From {stats.debug.revenueCount} bookings
                    </p>
                  )}
                </div>
                <IndianRupee className="h-12 w-12 text-purple-200" />
