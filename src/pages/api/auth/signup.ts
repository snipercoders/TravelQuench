...
//     const { name, firstName, lastName, email, phone, password, confirmPassword } = req.body;

//     // Use the combined name if firstName/lastName not provided, or construct from firstName/lastName
...
//     // Send welcome email
//     try {
//       const welcomeTemplate = emailTemplates.welcomeEmail(finalName);
...
//     res.status(201).json({
//       success: true,
//       message: 'Account created successfully! Welcome to Travel Quench. Check your email for a welcome message.',
//       user: {
//         id: user._id,
//         name: user.name,
//         firstName: user.firstName || finalFirstName,
//         lastName: user.lastName || finalLastName,
//         email: user.email,
//         phone: user.phone,
//         role: user.role,
...
//     // Send welcome email
//     try {
//       const welcomeTemplate = emailTemplates.welcomeEmail(name);
