...
// interface PopulatedWishlistItem extends Omit<WishlistItem, 'package'> {
//   package: {
//     _id: string;
//     title: string;
//     destination: string;
...
//     // Try different possible user ID fields
// // Replace line 344 with:
// const userId = decoded.id || decoded.userId || decoded._id || (decoded as any).sub;
...
//     const wishlist = user.wishlist.map((item: PopulatedWishlistItem) => ({
//       id: item._id,
//       packageId: item.package._id,
//       userId: userId,
//       addedAt: item.addedAt,
...
//     const newWishlistItem = user.wishlist[user.wishlist.length - 1] as PopulatedWishlistItem;
//     const responseItem = {
//       id: newWishlistItem._id,
//       packageId: newWishlistItem.package._id,
//       userId: userId,
