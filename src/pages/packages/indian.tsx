...
//     } catch (error: any) {
//       console.error('Error fetching domestic packages:', error);
//       setError(error.message || 'An error occurred while fetching packages. Please try again later.');
//     } finally {
//       setLoading(false);
//     }
//   };
...
//   const faqs = [
//     { q: 'What documents do I need for domestic travel in India?', a: 'For domestic travel, you typically need a government-issued photo ID like Aadhaar card, PAN card, or driving license.' },
//     { q: 'Is travel insurance necessary for domestic trips?', a: 'While not mandatory, travel insurance is recommended to cover medical emergencies, trip cancellations, and lost baggage.' },
//     { q: 'What is the best time to visit popular destinations in India?', a: 'The best time varies by region. North India is best visited in winter (Oct-Mar), while South India is pleasant in winter and summer.' },
//     { q: 'How early should I book domestic travel packages?', a: 'Book at least 1-2 months in advance to get better rates and availability, especially during peak seasons and festivals.' },
//   ];
...
//         <meta
//           name="description"
//           content="Discover amazing domestic travel packages across India. From Kashmir to Kerala, explore incredible destinations within India."
//         />
//       </Head>
//       <div className="bg-gray-50 min-h-screen">
...
//                 </div>
//               </div>
//               <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">Domestic Travel Packages</h1>
//               <p className="text-base sm:text-lg md:text-xl text-green-100 max-w-xl sm:max-w-2xl mx-auto">
//                 Discover the incredible diversity of India. From majestic Himalayas to serene backwaters, explore the beauty of your homeland.
//               </p>
//             </div>
//           </div>
//         </div>
...
//               <div className="bg-white rounded-xl border border-gray-200 p-6 sm:p-12 max-w-md mx-auto">
//                 <Mountain className="h-12 sm:h-16 w-12 sm:w-16 text-gray-400 mx-auto mb-3 sm:mb-4" />
//                 <h3 className="text-base sm:text-xl font-semibold text-gray-900 mb-2">Error Loading Packages</h3>
//                 <p className="text-gray-600 text-xs sm:text-sm mb-4 sm:mb-6">{error}</p>
//                 <Button
//                   onClick={fetchDomesticPackages}
...
//             <p className="text-lg text-gray-600">Everything you need to know about domestic travel!</p>
//           </div>
//           <div className="space-y-4">
//             {faqs.map((faq, index) => (
//               <details key={index} className="bg-gray-50 p-4 rounded-lg border-l-4 border-green-500">
...
//         <div className="max-w-4xl mx-auto px-4">
//           <h2 className="text-3xl font-bold text-center mb-8 text-gray-800">Domestic Travel Guidelines</h2>
//           <div className="space-y-4 text-gray-700">
//             <ol className="list-decimal pl-6 space-y-2">
//               <li>Carry a valid government-issued photo ID (Aadhaar, PAN card, or driving license) for hotel check-ins and transportation.</li>
//               <li>Check weather conditions and pack accordingly for your destination and season.</li>
//               <li>Book accommodations and transportation in advance, especially during peak seasons and festivals.</li>
//               <li>Keep emergency contacts handy and inform family/friends about your travel itinerary.</li>
//               <li>Carry necessary medications and a basic first aid kit for common ailments.</li>
//               <li>Research local customs, festivals, and cultural practices of your destination.</li>
//               <li>Keep both physical and digital copies of important documents.</li>
//               <li>Download offline maps and local transportation apps for convenience.</li>
//               <li>Respect local traditions, dress codes, and environmental guidelines.</li>
//               <li>Keep some cash handy as not all places accept digital payments.</li>
//               <li>Stay hydrated and try local cuisine cautiously to avoid stomach issues.</li>
//               <li>Purchase travel insurance to cover medical emergencies and trip cancellations.</li>
//             </ol>
//           </div>
//         </div>
//       </div>
...
const DomesticPackagesPage: React.FC = () => {
  ...
  const fetchDomesticPackages = useCallback(async () => {
    setLoading(true);
    setError(null);
    try {
      const queryParams = new URLSearchParams({
      ...
      console.error('Error fetching domestic packages:', error);
      const errorMessage = error instanceof Error ? error.message : 'An error occurred while fetching packages. Please try again later.';
      setError(errorMessage);
    } finally {
      setLoading(false);
    }
  }, [filters, setPackages, setLoading, setError]);
