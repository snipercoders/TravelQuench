...
//       id: '6',
//       name: 'Andaman',
//       image: 'https://images.unsplash.com/photo-1545565341-7b0c4e4d2b0e?w=400&h=300&fit=crop',
...
//             </p>
//           <Link href="/packages/international">
//   <Button className="bg-yellow-400 hover:bg-yellow-500 text-gray-900 font-bold px-6 sm:px-8 py-2 sm:py-3 rounded-xl shadow-lg">
//     Explore
//   </Button>
// </Link>
//           </div>
...
//                         <Button 
//                           size="sm"
//                           className="bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white border border-white/30 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300 text-xs sm:text-sm"
//                         >
//                           Explore
//                         </Button>
//                       </div>
