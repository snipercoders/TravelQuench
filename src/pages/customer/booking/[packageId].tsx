      ...
      <Layout title="Error">
        <div className="min-h-screen flex items-center justify-center px-4 sm:px-6">
          <div className="text-center">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Package Not Found</h2>
            <p className="text-sm sm:text-base text-gray-600 mb-4">{error || 'The package you\'re looking for doesn\'t exist.'}</p>
            <Button onClick={() => router.push('/packages/international')} className="w-full sm:w-auto">
              Browse Packages
            </Button>
          </div>
        </div>
  ...
  return (
    <Layout title={`Book ${package_?.title}`}>
      ...
      <div className="bg-gray-50 min-h-screen pt-6 sm:pt-8 md:pt-12">
        <div className="max-w-full sm:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-12">
          {/* Back Button */}
            ...
            <div className="lg:col-span-2 space-y-4 sm:space-y-6">
              ...
              <Card className="p-4 sm:p-6">
                <div className="flex flex-col sm:flex-row sm:items-start sm:space-x-4">
                  <div className="relative w-full sm:w-24 h-48 sm:h-24 rounded-lg overflow-hidden flex-shrink-0 mb-4 sm:mb-0">
                    <Image
                      src={package_?.thumbnail || '/images/placeholder-package.jpg'}
                      alt={package_?.title || 'Package'}
                      fill
                  ...
                  <div className="flex-1">
                    <div className="flex flex-wrap items-center gap-2 mb-2">
                      ...
                      <span className="text-xs sm:text-sm text-gray-600">{package_?.category}</span>
                    </div>
                    <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">{package_?.title}</h1>
              ...
              {package_?.highlights && package_.highlights.length > 0 && (
                <Card className="p-4 sm:p-6">
                  <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4">Package Highlights</h3>
                  <ul className="space-y-2">
                    {package_.highlights.map((highlight, index) => (
                      <li key={index} className="flex items-start">
              ...
              <div className="sticky top-20 space-y-4 sm:space-y-6">
                <Card className="p-4 sm:p-6">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-xl sm:text-2xl font-bold text-primary-600">₹{totalPrice.toLocaleString()}</span>
                  </div>

                  {error && (
                    <div className="mt-3 sm:mt-4 p-3 bg-red-50 border border-red-200 rounded-lg flex items-start">
                  ...
                  <button
                    onClick={handleButtonClick}
                    disabled={submitting}
                    className="w-full mt-4 sm:mt-6 bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white font-medium py-2 sm:py-3 px-4 rounded-lg flex items-center justify-center transition-colors text-sm sm:text-base"
                  ...
                  <div className="mt-3 sm:mt-4 flex items-center justify-center text-xs sm:text-sm text-gray-600">
                    <Shield className="w-4 h-4 mr-1" />
                    Secure booking process
                  </div>
                </Card>
                ...
                <Card className="p-4 sm:p-5">
                  <div className="text-center">
                    <h4 className="font-medium text-gray-900 mb-2 text-sm sm:text-base">Why Book With Us?</h4>
