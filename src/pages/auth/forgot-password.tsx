...
//   const [error, setError] = useState(''); // Used in form error display
...
const ForgotPasswordPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-purple-50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full">
          <Card padding="lg" className="bg-white p-8 rounded-lg shadow-lg">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-gray-900 mb-2">
                {isEmailSent ? 'Check Your Email' : 'Forgot Password?'}
              </h2>
            ...
            {isEmailSent ? (
              <div className="text-center">
                ...
                <p className="text-gray-700 mb-6">
                  If an account exists with <strong>{getValues('email')}</strong>, you will receive a password reset email shortly.
                </p>
                <p className="text-sm text-gray-500 mb-8">
                  Didn&apos;t receive the email? Check your spam folder or try again.
                </p>
