...
// // Generate JWT token with 2-day expiry
...
// // Verify JWT token
// export const verifyToken = (token: string): { userId: string; iat: number } | null => {
//   try {
...
//     // Check if token is still within 2-day validity
...
// export const generateSessionData = (userId: string, rememberMe: boolean = false) => {
//   const token = generateToken(userId);
//   const maxAge = rememberMe ? 2 * 24 * 60 * 60 * 1000 : 24 * 60 * 60 * 1000; // 2 days or 1 day
