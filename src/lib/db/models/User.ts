...
export interface IUser extends Document {
  ...
  addToWishlist(packageId: string): Promise<IUser>;
  removeFromWishlist(packageId: string): Promise<IUser>;
...
const UserSchema = new Schema<IUser>(
  {
    name: {
      ...
      maxlength: [100, 'Name cannot exceed 100 characters'], // Fixed: increased from 50
...
// Create compound unique index for phone (sparse allows multiple null values)
